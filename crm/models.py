...
class ClassList(models.Model):
    ...
    teachers = models.ManyToManyField(verbose_name='任课老师', to='UserInfo',limit_choices_to={'depart_id__in':[1008,1009]})
    tutor = models.ForeignKey(verbose_name='班主任', to='UserInfo', related_name='classes',limit_choices_to={'depart_id':1001,},on_delete=models.CASCADE)
...
class Customer(models.Model):
    ...
    date = models.DateField(verbose_name="咨询日期")
...
class PaymentRecord(models.Model):
    ...
    class_list = models.ForeignKey(verbose_name="班级", to="ClassList", blank=True, null=True,on_delete=models.CASCADE)
    ...
    consultant = models.ForeignKey(verbose_name="负责老师", to='UserInfo', help_text="谁签的单就选谁",on_delete=models.CASCADE)
